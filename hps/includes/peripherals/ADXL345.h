...
extern volatile int *I2C0_ptr;    	// virtual address pointer to I2C0	
extern volatile int *SYSMGR_ptr;   	// virtual address pointer to SYSMGR	
...
#define I2C0_FS_SCL_HCNT        (volatile unsigned int *)(I2C0_ptr + 0x00000007) // ((volatile unsigned int *) 0xffc0401c)
#define I2C0_FS_SCL_LCNT        (volatile unsigned int *)(I2C0_ptr + 0x00000008) // ((volatile unsigned int *) 0xffc04020)
#define I2C0_ENABLE             (volatile unsigned int *)(I2C0_ptr + 0x0000001B) // ((volatile unsigned int *) 0xffc0406c)
#define I2C0_RXFLR              (volatile unsigned int *)(I2C0_ptr + 0x0000001E) // ((volatile unsigned int *) 0xffc04078)
#define I2C0_ENABLE_STATUS      (volatile unsigned int *)(I2C0_ptr + 0x00000027) // ((volatile unsigned int *) 0xffc0409c)
...
#define SYSMGR_GENERALIO7       (volatile unsigned int *)(SYSMGR_ptr + 0x00000127) // 0xffd0849Cv
/* GENERALIO8 (trace_d7): 
...
#define SYSMGR_GENERALIO8       (volatile unsigned int *)(SYSMGR_ptr + 0x00000128) // 0xffd084A0
...
#define SYSMGR_I2C0USEFPGA      (volatile unsigned int *)(SYSMGR_ptr + 0x000001C1) // 0xffd08704
